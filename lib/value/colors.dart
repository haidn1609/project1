...
List<Color> yellowGradientColor = const [
  Color.fromRGBO(254, 218, 0, 1),
  Color.fromRGBO(194, 75, 8, 1)
];
List<Color> purpleGradientColor = const [
  Color.fromRGBO(247, 124, 251, 1),
  Color.fromRGBO(140, 73, 196, 1)
];
List<Color> pinkGradientColor = const [
  Color.fromRGBO(254, 134, 138, 1),
  Color.fromRGBO(184, 74, 121, 1)
];
List<Color> greenGradientColor = const [
  Color.fromRGBO(52, 185, 47, 1),
  Color.fromRGBO(5, 187, 30, 1)
];
